...
export default function AdjustPrintMarginPDF({ adjustDialog, setAdjustDialog, handleAdjust, loadingPreview }) {
                                ...
                                <div className="card">
                                    <div className="grid">
                                        <div className="col-6 md:col-12 lg:col-12">
                                            ...
                                            <div className="p-inputgroup" style={{ marginTop: '5px' }}>
                                                <Dropdown id="paperSize" value={dataAdjust.paperSize} options={paperSizes} optionValue="value" onChange={(e) => onInputChange(e, 'paperSize')} optionLabel="name" />
                                            </div>
                                        </div>
                                        <div className="col-6 md:col-12 lg:col-12">
                                            <label htmlFor="rekening">Orientasi</label>
                                            <div className="p-inputgroup" style={{ marginTop: '5px' }}>
                                                <Dropdown id="orientation" value={dataAdjust.orientation} options={orientationOptions} onChange={(e) => onInputChange(e, 'orientation')} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
