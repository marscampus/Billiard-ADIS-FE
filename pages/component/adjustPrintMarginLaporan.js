                    ...
                    <div className="col-12 md:col-6">
                        <div className="grid formgrid">
                            ...
                            <div className="col-12 field">
                                ...
                                <Dropdown id="paperSize" value={dataAdjust.paperSize} options={paperSizes} onChange={(e) => onInputChangeNumber(e, 'paperSize')} optionLabel="name" className="w-full" inputStyle={{ padding: '0.3rem' }} />
                            </div>

                            <div className="col-12 field">
                                <label htmlFor="orientation">Orientasi</label>
                                <Dropdown id="orientation" value={dataAdjust.orientation} options={orientationOptions} onChange={(e) => onInputChangeNumber(e, 'orientation')} className="w-full" inputStyle={{ padding: '0.3rem' }} />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-12 md:col-6">
                                <div className="grid formgrid mt-3">
                                    ...
                                    <div className="col-12 field">
                                        ...
                                        <InputText id="paraf1" value={dataAdjust.paraf1} onChange={(e) => onInputChange(e, 'paraf1')} className="w-full" placeholder="Masukkan inisial paraf" />
                                    </div>

                                    <div className="col-12 field">
                                        <label htmlFor="namaPetugas1">Nama Petugas</label>
                                        <InputText id="namaPetugas1" value={dataAdjust.namaPetugas1} onChange={(e) => onInputChange(e, 'namaPetugas1')} className="w-full" placeholder="Masukkan nama lengkap" />
                                    </div>

                                    <div className="col-12 field">
                                        <label htmlFor="jabatan1">Jabatan</label>
                                        <InputText id="jabatan1" value={dataAdjust.jabatan1} onChange={(e) => onInputChange(e, 'jabatan1')} className="w-full" placeholder="Masukkan jabatan" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-12 md:col-6">
                                <div className="grid formgrid mt-3">
                                    ...
                                    <div className="col-12 field">
                                        ...
                                        <InputText id="paraf2" value={dataAdjust.paraf2} onChange={(e) => onInputChange(e, 'paraf2')} className="w-full" placeholder="Masukkan inisial paraf" />
                                    </div>

                                    <div className="col-12 field">
                                        <label htmlFor="namaPetugas2">Nama Petugas</label>
                                        <InputText id="namaPetugas2" value={dataAdjust.namaPetugas2} onChange={(e) => onInputChange(e, 'namaPetugas2')} className="w-full" placeholder="Masukkan nama lengkap" />
                                    </div>

                                    <div className="col-12 field">
                                        <label htmlFor="jabatan2">Jabatan</label>
                                        <InputText id="jabatan2" value={dataAdjust.jabatan2} onChange={(e) => onInputChange(e, 'jabatan2')} className="w-full" placeholder="Masukkan jabatan" />
                                    </div>
                                </div>
                            </div>
                        </div>
