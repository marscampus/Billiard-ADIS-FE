    ...
    return (
        <div ref={ref} style={{ padding: '5px', fontFamily: 'Helvetica', fontSize: '10px', lineHeight: 1.2 }}>
            ...
            <div style={{ marginTop: '5px' }}>
                ...
                <p style={{ margin: '1px 0' }}>
                    PPN ({ppnPersen}%) : + {rupiahConverter(jumlahPPN)}
                </p>
                <p style={{ margin: '2px 0', fontWeight: 'bold', fontSize: '12px' }}>TOTAL: {rupiahConverter(hargaTotal)}</p>
            </div>
            ...
            <div style={{ marginTop: '5px' }}>
                ...
                {(sidebar?.laporan || sidebar?.reservasi) && <p style={{ margin: '1px 0' }}>Metode : {data?.cara_bayar}</p>}
                {!sidebar?.reservasi && (
                    <>
