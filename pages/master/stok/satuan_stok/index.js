...
export default function satuanStock() {
    ...
    const [satuanStockTabel, setSatuanStockTabel] = useState([]);
    const [satuanStockTabelFilt, setSatuanStockTabelFilt] = useState([]);
    const [satuanStockTabelAll, setSatuanStockTabelAll] = useState(null);
    ...
    const allData = async () => {
        ...
        setSatuanStockTabelAll(data.data);
    };
    ...
    const saveSatuanStock = async (e) => {
        ...
        let _satuanStock = { ...satuanStock };
        console.log('_satuanStock', _satuanStock);
        try {
            let endPoint;
            if (isUpdateMode) {
    ...
    //  Yang Handle Preview
    const btnAdjust = () => {
        if (satuanStockTabelFilt.length == 0 || !satuanStockTabelFilt) {
