...
export default function TableRegisterNasabah({onValue,onEdit}){
    ...
    return(
        ...
        >
            <Column field='id' header='CIF' />
            <Column field='title' header='NOMOR BERKAS' />
            <Column field='category' header='NAMA'/>
            <Column field='category' header='ALAMAT'/>
            <Column field='category' header='TGL DAFTAR'/>
